            ...
            <div class="col-9">
                <div class="card" style="margin-top: 20px;">
                    <div class="card-hearder" >
                        ...
                        <button type="button" class="btn btn-primary float-end" style="margin-top: 5px;" data-bs-toggle="modal" data-bs-target="#add-bot-btn">
                            创建Bot
                        </button>
                        <!-- Modal -->
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="mb-3">
                                          ...
                                          <input v-model="botadd.title" type="text" class="form-control" id="add-bot-title" placeholder="请输入Bot的标题">
                                        </div>
                                        <div class="mb-3">
                                          <label for="add-bot-description" class="form-label">描述</label>
                                          <textarea v-model="botadd.description" type="password" class="form-control" id="add-bot-description" placeholder="请输入Bot的描述"></textarea>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form>
                                                        ...
                                                        <div class="mb-3">
                                                          <label for="add-bot-description" class="form-label">描述</label>
                                                          <textarea v-model="bot.description" type="password" class="form-control" id="add-bot-description" placeholder="请输入Bot的描述"></textarea>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label for="add-bot-code" class="form-label">代码</label>
                                                            <VAceEditor
